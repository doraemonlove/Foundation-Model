...
from util.pot.grimshaw import grimshaw


def pot(data:np.array, risk:float=0.1, init_level:float=0.8, num_candidates:int=5, epsilon:float=1e-8) -> float:
    ...
    Args:
        ...
        risk:float=1e-4, init_level:float=0.98, num_candidates:int=10, epsilon:float=1e-8
    Returns:

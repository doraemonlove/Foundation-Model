...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', '-d', type=str, default='./dataset/electricity', help='Path to training data. (Folder contains data files, or data file)')
    parser.add_argument('--model_path', '-m', type=str, default='./TimeMoE-200M', help='Path to pretrained model. Default: ./TimeMoE-200M')
